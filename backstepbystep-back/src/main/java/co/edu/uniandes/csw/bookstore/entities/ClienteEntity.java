...
import co.edu.uniandes.csw.bookstore.podam.EmailStrategy;
...
public class ClienteEntity extends BaseEntity implements Serializable {
     ...
     */
    @PodamExclude
    private List<BookEntity> carritoDeCompras;

    /**
     * Atributo que modela la lista de deseos del cliente .
     */
    @PodamExclude
    private List<BookEntity> listaDeDeseos;
     ...
     */
    public List<BookEntity> getCarritoDeCompras() {
     ...
     */
    public void setCarritoDeCompras(List<BookEntity> carritoDeCompras) {
     ...
     */
    public List<BookEntity> getListaDeDeseos() {
     ...
     */
    public void setListaDeDeseos(List<BookEntity> listaDeDeseos) {
